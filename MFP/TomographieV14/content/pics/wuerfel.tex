\begin{tikzpicture}[scale=0.6, every node/.style={scale=0.6}]
  ...
  \node [red] at (11, 7.75) {\huge$I_{3}$};
  \node [blue] at (11, 6.75) {\huge$I_{4}$};
  \node [red] at (11, 4.5) {\huge$I_{5}$};
  \node [blue] at (11, 2.25) {\huge$I_{6}$};
  \node [red] at (11, 1.25) {\huge$I_{7}$};
  \node [blue] at (11, -2) {\huge$I_{8}$};
  \node [red] at (7.75, -2) {\huge$I_{9}$};
  \node [blue] at (6.75, -2) {\huge$I_{10}$};
  \node [red] at (1.5, -2) {\huge$I_{11}$};
  \node [red] at (4.5, -2) {\huge$I_{12}$};
