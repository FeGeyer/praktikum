...
\begin{table}[h]
  ...
  \begin{tabular}{c c}
    \toprule
    $t_{klein}$/\si{\second} & $t_{groß}$/\si{\second} \\
    \midrule
    13.23 & 87.38 \\
    13.24 & 87.35 \\
    13.20 & 88 \\
...
laminarer zu turbolenter Strömung charakterisiert beträgt ca. 2300. Die erhaltenen Werte liegen alle weit unter diesem Wert,
