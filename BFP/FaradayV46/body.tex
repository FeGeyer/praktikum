...
\begin{figure}
  \centering
  \subcaptionbox{Wellenlänge, gefitteter Brechungsindex und die daraus bestimmten
  effektiven Massen. \label{tab:n}}[0.5\textwidth]{
  \centering
  ...
  \\
  \subcaptionbox{Grafische Darstellung mit Regression. \label{fig:rn}}[0.6\textwidth]{
  \centering
...
Als Mittelwerte der effektiven Massen ergeben sich
\begin{align*}
