...
\begin{equation}
    ...
    \label{eqn:12}
\end{equation}
mit R als allgemeine Gaskonstante mit dem Wert $R = \SI{8.314}{\joule\per\kelvin\per\mol}$
und $M = \SI{120.9E-3}{\kilo\gram\per\mol}$ als molare Masse des Transportgases.
Für L ergibt sich also $\SI{1.68 \pm 0.10E5}{\joule\per\kilo\gram}$.
