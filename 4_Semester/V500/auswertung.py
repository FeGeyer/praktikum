...
plt.plot(UGeV, np.sqrt(IGenA),'y.', label="Gelb")
plt.plot(UGrV, np.sqrt(IGrnA),'g.', label="Grün")
plt.plot(UB2V, np.sqrt(IB2nA),'k.', label="Violett 1")
plt.plot(UB1V, np.sqrt(IB1nA),'b.', label="Violett 2")
plt.plot(UUVV, np.sqrt(IUVnA),'r.', label="Violett 3")
