...
$C_{\symup{ges}} = C_{\symup{sp}} + ( \frac{1}{C} + \frac{2}{C_{\symup{k}}} )^{-1}$ die in Tabelle \ref{tab:2} dargestellten
...
Messwerten. Die relativen Fehler sind wieder extrem gering. Die Werte für $C_{\symup{k}} = \SI{2.19}{\nano\farad}$
