...
\begin{table}[H]
  ...
  \begin{tabular}{c || c c c c c|c c c c c}
    ...
    $a_{\text{CsCl}}$ / pm \\
    \midrule
    \input{Auswertung/Grafiken/Salt_Tabelle.tex}
    \bottomrule
  \end{tabular}
\end{table}
...
Zwar weist die fcc-artige Hypothese einen größeren Fehler auf, bewegt sich aber
...
Gitterkonstante und teilen das weißliche Aussehen der Probensubstanz.
