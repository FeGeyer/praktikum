...
\section{Theorie}
Ziel des Versuchs ist die Betrachtung der $\textsc{Frauenhofer}$-Lichtbeugung an einem Parallelspalt.
...
entfernt liegt, dass der Lichtstrahl als paralleles Bündel auftrifft. Man spricht dann
davon, dass die Lichtquelle "ins unendliche verschoben wurde". Der erste Fall wird
als $\textsc{Fresnel}$-Beugung bezeichnet, der zweite Fall als $\textsc{Frauenhofer}$-Beugung.\\
...
\begin{itemize}
  ...
  Als Quelle solchen Lichtes werden bspw. Laser genutzt.
\end{itemize}
