...
Da die Linien nicht perfekt schaft abgebildet werden könnne, bieten sich hier
viele Möglichkeiten für Abweichungen. Diese Fehlerquelle ließe sich minimieren, indem die
Messwerte automatisch aus den Bildern errechnet werden. Hierzu bietet sich ein
Auslesen des Grauwertes des Bildes in Abhängigkeit von der Position auf der x-Achse
an. Als weitere systematische Fehlerquelle muss die Magnetfeldeichung in Betracht gezogen
