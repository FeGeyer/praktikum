...
\begin{figure}
  \centering
  \subcaptionbox{Graphische Darstellung des Emissionspektrums. \label{fig:2}}[0.5\textwidth]{
  \includegraphics[width=0.7\textwidth]{emission.pdf}
  }
  \hfill
  \subcaptionbox{Messwerte zum Emissionspektrum. \label{tab:1}}[0.29\textwidth]{
    \begin{tabular}{c c}
      \toprule
...
\begin{figure}
  ...
  \label{fig:7}
\end{figure}
Für die verschiedenen Materialien ergeben sich die Absorptionsenergien aus den Plots und
aus der Formel
\begin{equation}
